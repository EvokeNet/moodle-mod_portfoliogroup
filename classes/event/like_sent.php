...
class like_sent extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventlikesent', 'mod_portfoliogroup');
    }
    ...
    protected function init() {
        ...
        $this->data['objecttable'] = 'portfoliogroup_reactions';
    }
    ...
    public static function get_objectid_mapping() {
        return array('db' => 'portfoliogroup_reactions', 'restore' => 'portfoliogroup_reaction');
    }
}
