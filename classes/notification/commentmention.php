...
class commentmention {
    ...
    protected function get_mention_message_data() {
        ...
        $youwerementioned = get_string('message_mentioned', 'mod_portfoliogroup');
        $youwerementionedinaportfolio = get_string('message_mentionedinaportfolio', 'mod_portfoliogroup', $this->portfolioname);
        $clicktoaccessportfolio = get_string('message_clicktoaccessportfolio', 'mod_portfoliogroup');
        ...
        $url = new moodle_url("/mod/portfoliogroup/viewsubmission.php", $urlparams);

        $message = new message();
        $message->component = 'mod_portfoliogroup';
        ...
        $message->contexturlname = get_string('message_mentioncontextname', 'mod_portfoliogroup');
