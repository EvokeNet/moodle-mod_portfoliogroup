...
class comment extends external_api {
    ...
    public static function add($comment) {
        ...
        $cm = get_coursemodule_from_instance('portfoliogroup', $utildata->portfolioid);
        ...
        $insertedid = $DB->insert_record('portfoliogroup_comments', $usercomment);
    ...
    public static function edit($comment) {
        ...
        $DB->update_record('portfoliogroup_comments', $usercomment);
        ...
        return [
            'status' => 'ok',
            'message' => get_string('editcomment_success', 'mod_portfoliogroup')
        ];
    }
