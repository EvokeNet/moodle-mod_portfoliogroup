...
use mod_portfoliogroup\forms\chapter_form;
...
class entry extends external_api {
    ...
    public static function delete($id) {
        ...
        notification::success(get_string('entrydelete_success', 'mod_portfoliogroup'));

        return [
            'status' => 'ok',
            'message' => get_string('entrydelete_success', 'mod_portfoliogroup')
        ];
    }
