...
$event = \mod_portfoliogroup\event\course_module_instance_list_viewed::create([
    'context' => $context
]);
...
$PAGE->set_url('/mod/portfoliogroup/index.php', ['id' => $id]);
...
$contentrenderable = new \mod_portfoliogroup\output\index($context, $course);
