 ...
 */
class mod_portfoliogroup_mod_form extends moodleform_mod {
    ...
    public function definition() {
        ...
        $mform->addElement('text', 'name', get_string('name', 'mod_portfoliogroup'), array('size' => '64'));
    ...
    public function add_completion_rules() {
        ...
        $mform->addElement('checkbox', 'completionrequiresubmit', get_string('completionrequiresubmit', 'mod_portfoliogroup'), get_string('completionrequiresubmit_help', 'mod_portfoliogroup'));
    ...
    public function standard_grading_coursemodule_elements() {
        ...
        $sql = 'SELECT * FROM {portfoliogroup} WHERE course = :course AND grade <> 0 LIMIT 1';
