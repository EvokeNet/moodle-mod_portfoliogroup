...
define(['jquery', 'core/ajax', 'core/str', 'mod_portfoliogroup/sweetalert'], function($, Ajax, Str, Swal) {
    var STRINGS = {
    ...
    EntryDelete.prototype.registerEventListeners = function() {
        $("body").on("click", ".delete-portfoliogroup-entry", function(event) {
    ...
    EntryDelete.prototype.deleteEntryItem = function(eventTarget) {
        var request = Ajax.call([{
            methodname: 'mod_portfoliogroup_entrydelete',
            args: {
